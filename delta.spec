...
Version  : 0.7.1
Release  : 1
URL      : file:///aot/build/clearlinux/packages/delta/delta-0.7.1.tar.gz
Source0  : file:///aot/build/clearlinux/packages/delta/delta-0.7.1.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: delta-bin = %{version}-%{release}
Requires: delta-data = %{version}-%{release}
...
%package bin
Summary: bin components for the delta package.
Group: Binaries
Requires: delta-data = %{version}-%{release}

%description bin
bin components for the delta package.


%package data
Summary: data components for the delta package.
Group: Data

%description data
data components for the delta package.
...
install -m0644 /builddir/build/BUILD/delta/etc/completion/completion.zsh %{buildroot}/usr/share/zsh/site-functions/_delta
